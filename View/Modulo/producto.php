            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box_main">
                        ...
                        <div class="image_2"><img src="<?php echo RutaController::RutaView(); ?>images/img-2.png"></div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box_main_3">
                        ...
                        <div class="image_2"><img src="<?php echo RutaController::RutaView(); ?>images/img-3.png"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box_main_3">
                        ...
                        <div class="image_2"><img src="<?php echo RutaController::RutaView(); ?>images/img-4.png"></div>
                    </div>
                </div>
                <div class="col-md-6">
