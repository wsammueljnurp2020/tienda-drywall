            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="box_main_1">
                        <div class="zoomout frame"><img src="<?php echo RutaController::RutaView(); ?>images/img-6.png"></div>
                ...
                <div class="col-sm-4">
                    <div class="box_main_1">
                        <div class="zoomout frame"><img src="<?php echo RutaController::RutaView(); ?>images/img-7.png"></div>
                        <div class="padding_15">
                            <h2 class="speed_text">Speed cycle</h2>
                            <div class="post_text">Post by : Den <span style="float: right;">20-12-2019</span></div>
                            <p class="long_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using </p>
                ...
                <div class="col-sm-4">
                    <div class="box_main_1">
                        <div class="zoomout frame"><img src="<?php echo RutaController::RutaView(); ?>images/img-8.png"></div>
                        <div class="padding_15">
